...
import com.example.web_based_customer_support_system.dto.ChatMessageDTO;
import com.example.web_based_customer_support_system.dto.ChatSessionDTO;
import com.example.web_based_customer_support_system.modelentity.*;
...
public class ChatService {
    ...
    @Autowired private com.example.web_based_customer_support_system.repository.ChatMessageRepository chatMessageRepository;
    @Autowired private com.example.web_based_customer_support_system.repository.ChatSessionRepository chatSessionRepository;
    @Autowired private com.example.web_based_customer_support_system.repository.UserRepository userRepository;
    @Autowired private SimpMessagingTemplate messagingTemplate;

    // --- Send message ---
    public void sendMessage(String sessionId, Long senderId, String content, ChatMessage.SenderType senderType) {
        com.example.web_based_customer_support_system.modelentity.User sender = userRepository.findById(senderId)
    ...
    public ChatSession getOrCreateActiveSession(com.example.web_based_customer_support_system.modelentity.User user) {
    ...
    public List<ChatSession> getAgentSessions(Long agentId) {
        com.example.web_based_customer_support_system.modelentity.User agent = userRepository.findById(agentId)
